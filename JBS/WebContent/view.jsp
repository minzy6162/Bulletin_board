...
<body>
	...
	if(request.getAttribute("userID")!= null){
		jbsID = Integer.parseInt(request.getParameter("jbbID"));
	}
	if(jbsID == 0){
		...
		style="text-align: center; border: 1px solid #dddddd">
			...
			<tbody>
				<tr>
					...
					<td colspan="2"><%=jbs.getJbsTitle() %></td><%--1번글을 누르면 1번글의 제목을 가져오는--%>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="2"><%=jbs.getJbsDate().substring(0, 11)+ jbs.getJbsDate().substring(11, 13) + "시" +
							jbs.getJbsDate().substring(14, 16)+"분" %></td>
				</tr>
				<tr>
					<td style="width: 20%;">글내용</td>
					<td colspan="2" style="min-height: 200px; text-align: left;">
					<%=jbs.getJbsContent() %></td>
				</tr>				
			</tbody>
			</table>
